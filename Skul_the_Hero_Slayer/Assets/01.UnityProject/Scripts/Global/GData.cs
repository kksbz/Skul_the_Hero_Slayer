...
public static partial class GData
{
    ...
    public const string CASTLELOBBY_SCENE_NAME = "CASTLE-LOBBY";
    public const string CASTLELOBBY_SCENE_SUB_NAME = "부서진 마왕성";
    public const string DUNGEONLOBBY_SCENE_NAME = "LOBBY";
    public const string DUNGEONLOBBY_SCENE_SUB_NAME = "던전 입구";
    public const string STAGE_1_SCENE_NAME = "STAGE-1";
    public const string STAGE_1_SCENE_SUB_NAME = "깊은숲 초입";
