...
2023-03-05 / v0.4.5 Bug fix<br/>
2023-03-05 / v0.4.6 동일한 기능 변수 통합<br/>
2023-03-05 / v0.4.7 옵션창 배경음 설정 씬이동 시에도 적용되게 함, 플레이어 사망시 HP 0으로 출력<br/>
2023-03-07 / v0.4.8 Bug fix<br/>
2023-03-09 / v0.4.9 Bug fix, 플레이어 스킬쿨 UI 연동 및 피격판정 fix, 보스몬스터 솔팅레이어 수정<br/>
2023-03-09 / v0.5.0 보스몬스터 피격사운드 추가, 씬이동 시 UI출력 오류 수정<br/>
2023-03-09 / v0.5.1 보스몬스터 각 파츠 솔팅레이어 수정<br/>